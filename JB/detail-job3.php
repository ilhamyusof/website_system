						...
						<div class="section-title-two">
							<div class="row">
								 <?php 
                                    ...
                                    $stmt = $conn->prepare('SELECT * FROM job WHERE status = "Open" AND Category IN ("Corporate","IT")');
                                    $stmt->execute();
									...
									<div class="service-card">
										...
										<div class="view-more">
											...
											<div style="text-align: right;" class="view-more">
												<a href="detail-job_v1.php?id=<?php echo $job_id; ?>">Apply Now<i class='bx bx-right-arrow-alt'></i></a>
											</div>
									</div>
								</div>
								 <?php
