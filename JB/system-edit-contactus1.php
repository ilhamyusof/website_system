                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2 custom-select" data-placeholder="Choose one" name="type" id="type">
                                                            <option value="" <?php if($type == "NULL"){ echo "selected"; }else{} ?>>-- Choose One--</option>
                                                            <option value="Refund" <?php if($type == "Refund"){ echo "selected"; }else{} ?>>Refund</option>
                                                            <option value="Feedback" <?php if($type == "Feedback"){ echo "selected"; }else{} ?>>Feedback</option>
                                                            <option value="Complaint" <?php if($type == "Complaint"){ echo "selected"; }else{} ?>>Complaint</option>
                                                     </select>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-md-12">
                                                <label class="form-label">Remark </label>                                                   
                                                <textarea class="form-control" rows="6" name="remark" id="remark"><?php echo $remark; ?></textarea>
                                            </div>                                          
										</div>
									</div>
