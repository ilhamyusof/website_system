            ...
            <div class="page-main">
                ...
                <aside class="app-sidebar">
                  ...
                  ?>
                        ...
                        <li>
                            <a class="side-menu__item" href="system-managelead.php"><i class="side-menu__icon fas fa-file"></i><span class="side-menu__label">Clinic Assistant Report</span></a>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fas fa-window-restore"></i><span class="side-menu__label">Voucher</span><i class="angle fas fa-angle-right"></i></a>
                            <ul class="slide-menu">
                                <li><a class="slide-item" href="system-giftcard.php">Gift Card</a></li>
                                <li><a class="slide-item" href="system-giftcard-redeem.php">Record Redeem Gift Card</a></li>
                            </ul>
                        </li>
                        <!--<li>-->
                        <!--    <a class="side-menu__item" href="system-giftcard.php"><i class="side-menu__icon fas fa-window-restore"></i><span class="side-menu__label">Gift Card</span></a>-->
                        <!--</li>-->
                        <li>
                    ...
                    <?php } else if($roles == "9" || $roles == "15" || $roles == "21") { ?>
                        <ul class="side-menu"> 
                            ...
                            <li>
                                <a class="side-menu__item" href="system-lead.php"><i class="side-menu__icon fas fa-file"></i><span class="side-menu__label">Clinic Assistant Report</span></a>
                            </li>
                            <li>
                            <a class="side-menu__item" href="system-giftcard.php"><i class="side-menu__icon fas fa-window-restore"></i><span class="side-menu__label">Gift Card</span></a>
                             </li>
                    ...
                    <?php } else if($roles == "13" || $roles == "20") { ?>
                       ...
                       <li>
                        ...
                        <li class="slide">
                            <a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fas fa-table"></i><span class="side-menu__label">Gift Cards</span><i class="angle fas fa-angle-right"></i></a>
                            <ul class="slide-menu">                                
                                <li>
                                    <a href="system-giftcard-search.php" class="slide-item">Search Gift Card</a>
                                </li>
                                <li>
                                    <a href="system-giftcard.php" class="slide-item">Gift Card</a>
                                </li>
