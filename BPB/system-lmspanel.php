														...
														<?php 
															...
															<div class="col-md-4 col-sm-4 col-xs-12">
																<div class="card card-primary text-center">
																	...
																	<div class="card-footer">
																		<a href="system-lmsmanagementdetail.php?id=<?php echo $id_department; ?>"><span class="label label-success float-left mb-0"><?php echo $job_department; ?></span></a>
																		<span class="float-right">
																			<a href="#" class="btn btn-danger btn-xs tip" title="Delete">
																				<i class="fas fa-trash"></i>
																			</a>				
										...
										<div class="panel panel-default mt-2">
											...
											<div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
												<div class="panel-body">
													<div class="row">
														<?php 
							                            $statement = $conn->prepare("SELECT * FROM department WHERE category = 'administrative'");
							                            $statement->execute();
							                           	while($data = $statement->fetch(PDO::FETCH_ASSOC))
								                           {
								                           	extract($data);
