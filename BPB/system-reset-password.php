...
<!-- Mirrored from spruko.com/demo/ren/Blue-animated/LeftMenu/forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Sep 2018 05:04:24 GMT -->
<head>
		<meta charset="UTF-8">
				...
				<div class="container">
					<div class="row">
						<div class="col col-login mx-auto">
                            ...
                            // }
                            ?>
							<form class="card" action="forgetpassword_v2.php" method="post">
								<div class="card-status bg-primary br-tr-3 br-tl-3"></div>
								<div class="card-body p-6">
									<div class="text-center card-title">Reset password <?php echo $_GET["id"];?></div>
									<div class="form-group">
										<label class="form-label" for="exampleInputEmail1">New Password</label>
										<input type="email" class="form-control" id="newpassword"  placeholder="Enter New Password">
									</div>
									<div class="form-group">
										<label class="form-label" for="exampleInputEmail1">Confirmation Password</label>
										<input type="email" class="form-control" id="confirmationpassword"  placeholder="Enter Confirmation Password">
									</div>
