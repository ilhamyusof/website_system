				...
				<div class="app-content my-3 my-md-5">
					<div class="side-app">
						<div class="page-header">
							<h4 class="page-title">Data Appointment / Bandar Puteri Bangi</h4>
							<ol class="breadcrumb">
						...
						<?php 
                            		$statement = $conn->prepare("SELECT COUNT(*) AS ctn FROM inquiry  WHERE status IN ('New') AND branch IN ('Bandar Puteri Bangi','5')");
                            		$statement->execute();
                            
                            		$statement1 = $conn->prepare("SELECT COUNT(*) AS ctn1 FROM inquiry  WHERE status IN ('Pending') AND branch IN ('Bandar Puteri Bangi','5')");
                            		$statement1->execute();
													...
													<div class="panel-body">
                                                        <div class="row">
                                                        	<div class="table-responsive">
																<table id="example16" class="table table-striped table-bordered" style="width:100%">
																	<thead>
																		<tr>
																	...
																	<?php 
								                                        $statement = $conn->prepare("SELECT * FROM inquiry WHERE branch IN ('Bandar Puteri Bangi','5') AND status = 'New' ORDER BY respond_date DESC ");
								                                        $statement->execute();
										...
										<div class="panel panel-default mt-2">
											...
											<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
												<div class="panel-body">
													<div class="row">
														<div class="table-responsive">
																<table id="example17" class="table table-striped table-bordered" style="width:100%">
																	<thead>
																		<tr>
																			<th class="wd-15p">Detail</th>
																			<th class="wd-15p">Status</th>
																	...
																	<?php 
								                                        $statement = $conn->prepare("SELECT * FROM inquiry WHERE branch IN ('Bandar Puteri Bangi','5') AND status = 'Pending' ORDER BY respond_date DESC ");
								                                        $statement->execute();
										...
										<div class="panel panel-default mt-2">
											...
											<div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
												<div class="panel-body">
													<div class="row">
														<div class="table-responsive">
																<table id="example18" class="table table-striped table-bordered" style="width:100%">
																	<thead>
																		<tr>
																			<th class="wd-15p">Detail</th>
																			<th class="wd-15p">Status</th>
																	...
																	<?php 
								                                        $statement = $conn->prepare("SELECT * FROM inquiry WHERE branch IN ('Bandar Puteri Bangi','5') AND status = 'Close' ORDER BY respond_date DESC ");
								                                        $statement->execute();
