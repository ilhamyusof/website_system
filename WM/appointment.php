				...
				<div class="col-lg-6">
					<div class="appointment-text">
						...
						<div class="appointment-form">
							...
							<div class="col-lg-12">
								<div class="form-group"><input type="email" class="form-control" id="email" name="email" placeholder="Enter your email "></div>
							</div>
							<div class="col-lg-12">
							...
							<div class="col-lg-12">
								<div class="form-group">
									...
									<!--	<option value="Bandar Botanik">BANDAR BOTANIK, KLANG</option>-->
									<!--	<option value="Eco Ardence">ECO ARDENCE, SETIA ALAM</option>-->
									<!--</select>-->
									<select class="form-control" name="branch" id="branch" required>
