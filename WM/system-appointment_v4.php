                                                        ...
                                                        <div class="row">
                                                        	<div class="table-responsive">
																<table id="example13" class="table table-striped table-bordered" style="width:100%">
																	...
																	<?php 
								                                        $statement = $conn->prepare("SELECT * FROM inquiry WHERE branch IN ('Wangsa Melawati', '3') AND status = 'New'");
								                                        $statement->execute();
													...
													<div class="row">
														<div class="table-responsive">
																<table id="example14" class="table table-striped table-bordered" style="width:100%">
																	...
																	<?php 
								                                        $statement = $conn->prepare("SELECT * FROM inquiry WHERE branch IN ('Wangsa Melawati', '3') AND status = 'Pending' ");
								                                        $statement->execute();
													...
													<div class="row">
														<div class="table-responsive">
																<table id="example15" class="table table-striped table-bordered" style="width:100%">
																	...
																	<?php 
								                                        $statement = $conn->prepare("SELECT * FROM inquiry WHERE branch IN ('Wangsa Melawati', '3') AND status = 'Close' ");
								                                        $statement->execute();
