                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <center><a href="ticket/<?php echo $document; ?>" download><i class="fa fa-file-pdf-o" style="font-size:200px;color:red"></i></a><br></center>
                                                </div>
                                            </div>
                                            <?php 
                                            } else {
                                            ...
                                            <div class="col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    <label class="form-label">Please Refer Attachment File</label>
                                                    <span style="color: black; font-size: 8pt;">Your document request has been done.</span>
                                                    <center><a href="ticket/<?php echo $document2; ?>" download><i class="fa fa-file-pdf-o" style="font-size:200px;color:red"></i></a><br></center>
                                                </div>
                                            </div>
                                            <?php 
                                            } else {
