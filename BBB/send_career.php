...
if(isset($_POST["submit"])){
        ...
        $mail = new PHPMailer(true);  
         try {
            ...
            <p>If you have a general question regarding Physiomobile, please check our website through <a href='https://physiomobile.com.my/'>www.physiomobile.com.my</a> and head on over to the FAQ section.</p>
