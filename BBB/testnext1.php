			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-7">
						...
						<h1 style="color: white; font-weight: bold;">PHYSIOTHERAPY TREATMENT CENTER</h1>
						
						<p style="text-align:justify; color: white; size: 14px;">We are a team of passionate physiotherapists that specializes in treating patient with any musculoskeletal disorders such as back pain, neck pain, shoulder pain, knee pain and etc. Besides that, we are also providing comprehensive and intensive rehab for patients with neurological problem, sport injuries, pediatrics, geriatrics as well as post-surgery patients.</p>
					...
					<div class="col-lg-5">
							<div class="banner-img">
								...
								<div class="image-1">
									<img src="assets/img/all-image-website/website-01.jpg" alt="Image">
								</div>
								<div class="image-2">
									<img src="assets/img/all-image-website/website-03.jpg" alt="Image">
								</div>
								<div class="image-3">
									<img src="assets/img/all-image-website/website-02.jpg" alt="Image">
								</div>
							</div>
					</div>
				</div>
					  ...
					  <ol class="carousel__viewport">
					    <li id="carousel__slide1"
					      ...
					      <div class="carousel__snapper">
					      	 <!--<iframe width="1110" height="815" src="https://www.youtube.com/embed/a9wXwr63WXQ?autoplay=1&mute=1"></iframe>-->
					      	 <iframe width="1110" height="815" src="https://www.youtube.com/embed?listType=playlist&amp;list=PLr593kIEuJqCa9ZDA6rgB0t1Kw5YAY_sQ" frameborder="0" allowfullscreen></iframe>
		...
		<div class="team-area ptb-100">
			<div class="container">
				...
				<div class="team-slider owl-carousel owl-theme">
					<div class="team-card">
						<a href="">
							<img src="assets/img/all-image-website/kd.jpeg" alt="Image">
						</a>
						<div class="caption">
					...
					<div class="team-card">
						<a href="#">
							<img src="assets/img/all-image-website/ks.jpeg" alt="Image">
						</a>
							<div class="caption">
...
45000 Kuala Selangor, Selangor.</span>
					...
					<div class="team-card">
						<a href="#">
							<img src="assets/img/all-image-website/wm.jpeg" alt="Image">
						</a>
							<div class="caption">
					...
					<div class="team-card">
						<a href="#">
							<img src="assets/img/all-image-website/sa.jpeg" alt="Image">
						</a>
							<div class="caption">
					...
					<div class="team-card">
						<a href="#">
							<img src="assets/img/all-image-website/bpb.jpeg" alt="Image">
						</a>
							<div class="caption">
					...
					<div class="team-card">
						<a href="#">
							<img src="assets/img/all-image-website/jb.jpeg" alt="Image">
						</a>
							<div class="caption">
					...
					<div class="team-card">
						<a href="https://www.google.com.my/maps/place/PHYSIOMOBILE+BANDAR+BARU+BANGI/@2.9612284,101.7518877,17z/data=!3m1!4b1!4m5!3m4!1s0x31cdcb88bf28c5c1:0xd4570668fe250e77!8m2!3d2.9614149!4d101.7541814">
							<img src="assets/img/all-image-website/bbb.jpeg" alt="Image">
						</a>
							<div class="caption">
					...
					<div class="team-card">
						<a href="https://www.google.com.my/maps/place/PHYSIOMOBILE+KRUBONG+MELAKA/@2.3047635,102.2503577,17z/data=!3m1!4b1!4m5!3m4!1s0x31d1fb0cbe1550e1:0xa3c276cb897d4662!8m2!3d2.3047581!4d102.2525464">
							<img src="assets/img/all-image-website/krubong.jpeg" alt="Image">
						</a>
							<div class="caption">
			...
			<div class="col-lg-6">
				<div class="information-text">
					<div class="section-title-two three">
						...
						<h2>CONTACT US</h2>
						<p style="text-align: justify;">If you have any questions or queries a member of staff will always be happy to help. Feel free to contact us by telephone or email and we will be sure to get back to you as soon as possible.</p>
					</div>
					<div class="appointment-form">
						<form method="POST" action="contactus.php"  enctype="multipart/form-data">
							...
							<div class="col-lg-12">
								<div class="form-group">
									<textarea class="form-control" cols="5" rows="6" name="message" id="message" placeholder="Write your message"></textarea>
								</div>
							</div>
