...
.mySlides {display:none;}
			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-7">
						...
						<img src="assets/img/all-image-website/headline.png" title="No more pain" alt="No more pain">
						<p style="text-align:justify; color: white; size: 14px;"> Are you suffering from Back Pain, Neck Pain, Shoulder Pain, Knee Pain, Slipped Disc, or Stroke ?? Get your <strong style="text-transform: uppercase;"><a href = "https://physiomobile.com/contact.php">FREE consultation now with Physiomobile</a></strong> !!
						<br><br>
						Since 2016, we helped more than 30,000 patients to gain back their confidence, eliminate those fear of their pain, and we restore their happiness to have a healthy and active lifestyle back on track. Physiomobile also provides comprehensive and intensive rehabilitation for Neurological Problem, Sport Injuries, Pediatrics, Geriatrics as well as Post-Surgery patients.
						</p>
						</div>
					</div>
					<div class="col-lg-5">
							<div class="banner-img">
								<div class="shape-1">
									<img src="assets/img/all-image-website/shape-red.png" alt="Shape">
								</div>
								<div class="shape-2">
									<img src="assets/img/all-image-website/shape-red-05.png" alt="Shape">
								</div>
								<div class="image-1">
									<img src="assets/img/all-image-website/home-page-01.jpg" alt="Image">
								</div>
								<div class="image-2">
									<img src="assets/img/all-image-website/home-page-03.jpg" alt="Image">
								</div>
								<div class="image-3">
									<img src="assets/img/all-image-website/home-page-02.jpg" alt="Image">
								</div>
							</div>
					</div>
				</div>
		...
		<div class="dedicated-area pt-100 pb-100">
    		<div class="container">
    			<div class="section-title-three">
    				<h2 style="text-transform: uppercase;text-justify: inter-word; color :#94171B;">OUR SERVICES</h2>
    			</div>
					...
					<div class="dedicated-card">
						...
						<div class="d-card-text">
						    ...
						    <div class="section-title-one">
								<ul>
									<li style="text-align: left; color :#fff; font-weight: bold;"><a href="neckpain.php"><i class='bx bx-check-circle'></i><u>NECK PAIN </u></li></a>
       ...
       <div class="team-area bg-f6f4ff ptb-100">
			<div class="container">
				<div class="section-title-three">
    				<h2 style="text-transform: uppercase;text-justify: inter-word; color :#94171B;">PROMOTION</h2>
    			</div>
			</div>
			<div class="row">
			    ...
			    <div class="col-lg-10">
        			<div class="w3-content w3-display-container">
                      <a href="https://physiomobile.com/detail-promotion.php?id=13"><img class="mySlides" src="assets/img/all-image-website/promotion-03.jpg" style="width:100%"></a>
                      <a href="https://physiomobile.com/detail-promotion.php?id=19"><img class="mySlides" src="assets/img/all-image-website/promotion-04.jpeg" style="width:100%"></a>
                      <!--<img class="mySlides" src="assets/img/all-image-website/promotion-02.jpeg" style="width:100%">-->
                      <!--<img class="mySlides" src="assets/img/all-image-website/promotion-01.jpeg" style="width:100%">-->
        ...
        <div class="clients-area bg-color  ptb-100">
            <div class="container">
                <div class="section-title-three">
                    <h2 style="text-transform: uppercase;text-justify: inter-word; color :#FFF ";>Customer Feedback</h2>
                </div>
                <div class="clients-slider owl-carousel owl-theme">
                    <div class="clients-card">
                        <div class="client-img">
                            <iframe width="100%" height="200px" src="https://www.youtube.com/embed/vOT_3uD4TRs?autoplay=0&mute=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                    ...
                    <div class="clients-card">
                        <div class="client-img">
                            <iframe width="100%" height="200px" src="https://www.youtube.com/embed/1RcEFn01Un4?autoplay=0&mute=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <div class="clients-name">
                            <h3>NECK PAIN</h3>
                        </div>
                    ...
                    <div class="clients-card">
                        <div class="client-img">
                            <iframe width="100%" height="200px" src="https://www.youtube.com/embed/ciBV1BS22qc?autoplay=0&mute=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <div class="clients-name">
                            <h3>SHOULDER PAIN</h3>
                        </div>
                    ...
                    <div class="clients-card">
                        <div class="client-img">
                            <iframe width="100%" height="200px" src="https://www.youtube.com/embed/EcjyLutUipY?autoplay=0&mute=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <div class="clients-name">
                            <h3>FROZEN SHOULDER PAIN</h3>
                        </div>
                    </div>
                </div>
            </div>
		...
		<div class="team-area  bg-f6f4ff ptb-100">
			<div class="container">
				<div class="section-title-three">
					<h2 style="text-transform: uppercase;text-justify: inter-word; color :#94171B;">FIND US </h2>
				</div>
				<div class="team-slider owl-carousel owl-theme">
					<div class="team-card">
						<a href="KD/portal-kd.php">
							<img src="assets/img/all-image-website/outlet-kd.jpg" title="PHYSIOMOBILE KOTA DAMANSARA" alt="PHYSIOMOBILE KOTA DAMANSARA">
						</a>
						<div class="caption">
							<h3><a href="KD/portal-kd.php">KOTA DAMANSARA</a></h3>
					...
					<div class="team-card">
						<a href="KS/portal-ks.php">
							...
							<div class="caption">
								<h3><a href="KS/portal-ks.php">KUALA SELANGOR</a></h3>
								<span>Klinik PhysioMobile Kuala Selangor, No 19-G, Jalan Warisan 1, Taman Warisan, 45000 Kuala Selangor, Selangor.</span>
								<ul class="social-link">
									<li>
					...
					<div class="team-card">
						<a href="BPB/portal-bpb.php">
							...
							<div class="caption">
							<h3><a href="BPB/portal-bpb.php">BANDAR PUTERI BANGI</a></h3>
					...
					<div class="team-card">
						<a href="BBB/portal-bbb.php">
							...
							<div class="caption">
							<h3><a href="BBB/portal-bbb.php">BANDAR BARU BANGI</a></h3>
					...
					<div class="team-card">
						<a href="KM/portal-krubong.php">
							...
							<div class="caption">
							<h3><a href="KM/portal-krubong.php">KRUBONG MELAKA</a></h3>
					...
					<div class="team-card">
						<a href="EA/portal-ea.php"><img src="assets/img/all-image-website/outlet-ecoardence.jpg" title="PHYSIOMOBILE ECO ARDENCE" alt="PHYSIOMOBILE ECO ARDENCE"></a>
							<div class="caption">
							<h3><a href="EA/portal-ea.php">ECO ARDENCE</a></h3>
					...
					<div class="team-card">
						<a href="BB/portal-botanik.php">
							...
							<div class="caption">
							<h3><a href="BB/portal-botanik.php">BANDAR BOTANIK KLANG</a></h3>
					...
					<div class="team-card">
						<a href="SK/portal-sk.php">
							...
							<div class="caption">
							<h3><a href="SK/portal-sk.php">SERI KEMBANGAN</a></h3>
