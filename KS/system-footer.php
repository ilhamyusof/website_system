...
<?php 
		...
		$statement1 = $conn->prepare("SELECT COUNT(*) AS ctn1 FROM inquiry WHERE (respond_date BETWEEN '2021-12-29' AND '2022-10-28') AND status = 'Pending' AND branch IN ('Kota Damansara','4') ");
		$statement1->execute();

		$statement2 = $conn->prepare("SELECT COUNT(*) AS ctn2 FROM inquiry WHERE (respond_date BETWEEN '2021-12-29' AND '2022-10-28') AND status = 'Close' AND branch IN ('Kota Damansara','4')");
		$statement2->execute();
...
<?php 
		...
		$statement1 = $conn->prepare("SELECT COUNT(*) AS ctn1 FROM inquiry WHERE (respond_date BETWEEN '2021-12-29' AND '2022-10-28') AND status = 'Pending' AND branch IN ('Bandar Puteri Bangi','5') ");
		$statement1->execute();

		$statement2 = $conn->prepare("SELECT COUNT(*) AS ctn2 FROM inquiry WHERE (respond_date BETWEEN '2021-12-29' AND '2022-10-28') AND status = 'Close' AND branch IN ('Bandar Puteri Bangi','5')");
		$statement2->execute();
...
<?php 
		...
		$statement1 = $conn->prepare("SELECT COUNT(*) AS ctn1 FROM inquiry WHERE (respond_date BETWEEN '2021-12-29' AND '2022-10-28') AND status = 'Pending' AND branch IN ('Krubong Melaka','10') ");
		$statement1->execute();

		$statement2 = $conn->prepare("SELECT COUNT(*) AS ctn2 FROM inquiry WHERE (respond_date BETWEEN '2021-12-29' AND '2022-10-28') AND status = 'Close' AND branch IN ('Krubong Melaka','10')");
		$statement2->execute();
...
<?php 
		...
		$statement1 = $conn->prepare("SELECT COUNT(*) AS ctn1 FROM inquiry WHERE (respond_date BETWEEN '2021-12-29' AND '2022-10-28') AND status = 'Pending' AND branch IN ('Bandar Tun Hussein Onn','14') ");
		$statement1->execute();

		$statement2 = $conn->prepare("SELECT COUNT(*) AS ctn2 FROM inquiry WHERE (respond_date BETWEEN '2021-12-29' AND '2022-10-28') AND status = 'Close' AND branch IN ('Bandar Tun Hussein Onn','14')");
		$statement2->execute();
