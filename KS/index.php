			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-7">
						...
						<!--<span style="color: white;">Explore us</span>-->
						<!--<h1 style="color: white; text-transform: uppercase;">Physiomobile</h1>-->
						<!--<h1 style="color: white;"><strong style="text-transform: uppercase;">Physiomobile </strong><strong><h1 style="color: white; font-weight: bold; font-size: 45px;">ENRICHING QUALITY OF LIFE<h1></strong></h1>-->
						<!--<h1 style="color: white;  text-transform: uppercase;  font-size: 45px; text-align:left; text-justify: inter-word;">No more pain !<br> <strong style="text-transform: uppercase; font-size: 25px; font-weight: bold;">More than 30,000 patients recover </strong> </h1>-->
...
<!--<div class="testimonials-card ptb-100">-->
<!--    <div class="container">-->
<!--        <div class="section-title-one">-->
<!--        <h2>Testimonials</h2>-->
<!--        </div>-->
...
<!--                <div class="clients-card" style = "width: 100%; height: 100px;">-->
<!--                    <div class="client-img" style = "width: 100%; height: 100px;">-->
<!--                        <iframe style = "width: 100%; height: 100px;" src="https://www.youtube.com/embed/eQrdFhEoWO4?autoplay=0&mute=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>-->
<!--                    </div>-->
<!--                    <p style =" text-align: justify;">En Sulaiman dari Bangi, mendapatkan rawatan fisioterapi dari pusat -->
<!--                        fisioterapi Physiomobile Bandar Puteri Bangi bagi masalah SLIP DISC yang beliau hadapi sejak zaman bujang.</p><br>-->
<!--                    <div class="clients-name">-->
<!--                        <h3>SULAIMAN ABDUL</h3>-->
...
<!--            </div>-->
            ...
            <!--</div>-->
            <!--<p>I have started work with this agency and it give us the special support on the global market. It has a brilliant team for treat</p>-->
            <!--<div class="clients-name">-->
            ...
            <!--<i class='bx bxs-quote-left'></i>-->
            <!--</div>-->
            <!--<p>"This has the most hi tech and most effective & the doctor has appear here is highly profiled. It will make a proper image".</p>-->
            <!--<div class="clients-name">-->
            ...
            <!--<div class="clients-card">-->
            <!--<div class="client-img">-->
            <!--<img src="assets/img/doctors/doctor-13.jpg" alt="Image">-->
            <!--<i class='bx bxs-quote-left'></i>-->
            <!--</div>-->
            <!--<p>"This has the most hi tech and most effective & the doctor has appear here is highly profiled. It will make a proper image".</p>-->
            <!--<div class="clients-name">-->
            ...
            <!--<div class="clients-card">-->
            <!--<div class="client-img">-->
            <!--<img src="assets/img/doctors/doctor-14.jpg" alt="Image">-->
            <!--<i class='bx bxs-quote-left'></i>-->
            <!--</div>-->
            <!--<p>"This has the most hi tech and most effective & the doctor has appear here is highly profiled. It will make a proper image".</p>-->
            <!--<div class="clients-name">-->
            ...
            <!--<div class="clients-card">-->
            <!--<div class="client-img">-->
            <!--<img src="assets/img/doctors/doctor-15.jpg" alt="Image">-->
            <!--<i class='bx bxs-quote-left'></i>-->
            <!--</div>-->
            <!--<p>"This has the most hi tech and most effective & the doctor has appear here is highly profiled. It will make a proper image".</p>-->
            <!--<div class="clients-name">-->
