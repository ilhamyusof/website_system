    ...
    <div class="d-table">
      <div class="d-table-cell">
        <div class="container">
          ...
          <h2>Physiomobile SME Prihatin</h2>
            <ul>
              <li><a href="index.php">Home</a></li>
              <li>Physiomobile SME Prihatin</li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <div class="about-area ptb-100" style="background: #F5F5F5;">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="about-img">
            <div class="main-img"><img src="assets/img/all-image-website/sme-1.jpeg" alt="Image">
        ...
        <div class="col-lg-6">
          <div class="about-text">
            <div class="section-title-two">
              <h2 style="color: #94171B; text-transform: uppercase;">SME Prihatin</h2>
