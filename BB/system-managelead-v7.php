                        ...
                        <div class="card-body">
                            ...
                            <div class=" text-dark">
                                ...
                                <form class="card" method="POST"  enctype="multipart/form-data">
                                    ...
                                    $statement = $conn->prepare("SELECT COUNT(*) AS totalleads FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND user_id = '$user_id'");
                                    $statement->execute();
                            
                                    $statement1 = $conn->prepare("SELECT COUNT(*) AS totalclose FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND status = 'Close' AND user_id = '$user_id'");
                                    $statement1->execute();
                            
                                    $statement2 = $conn->prepare("SELECT COUNT(*) AS totalpending FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND status = 'Pending' AND user_id = '$user_id'");
                                    $statement2->execute();
                                    
                                    $statement3 = $conn->prepare("SELECT COUNT(*) AS totalnotclose FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND status = 'Not Close' AND user_id = '$user_id'");
                                    $statement3->execute();
                                ...
                                ?>
                                    ...
                                    $centers_id = $_GET["branch"];
                                    // SELECT (COUNT(status)*100 /(Select COUNT(*) From inquiry)) AS ctn1 From inquiry WHERE status = 'Pending'
                                    $statement = $conn->prepare("SELECT COUNT(*) AS ctn FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND centers_id = '1' AND user_id = '$user_id'");
                                    $statement->execute();
                            
                                    $statement1 = $conn->prepare("SELECT COUNT(*) AS ctn1 FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND centers_id = '2' AND user_id = '$user_id'");
                                    $statement1->execute();
                            
                                    $statement2 = $conn->prepare("SELECT COUNT(*) AS ctn2 FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND centers_id = '3' AND user_id = '$user_id'");
                                    $statement2->execute();
                                    
                                    $statement3 = $conn->prepare("SELECT COUNT(*) AS ctn3 FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND centers_id = '4'AND user_id = '$user_id'");
                                    $statement3->execute();
                                    
                                    $statement4 = $conn->prepare("SELECT COUNT(*) AS ctn4 FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND centers_id = '5' AND user_id = '$user_id'");
                                    $statement4->execute();
                                    
                                    $statement5 = $conn->prepare("SELECT COUNT(*) AS ctn5 FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND centers_id = '6' AND user_id = '$user_id'");
                                    $statement5->execute();
                                    
                                    $statement6 = $conn->prepare("SELECT COUNT(*) AS ctn6 FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND centers_id = '7' AND user_id = '$user_id'");
                                    $statement6->execute();
                                    
                                    $statement7 = $conn->prepare("SELECT COUNT(*) AS ctn7 FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND centers_id = '8' AND user_id = '$user_id'");
                                    $statement7->execute();

                                    $statement8 = $conn->prepare("SELECT COUNT(*) AS ctn8 FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND centers_id = '9' AND user_id = '$user_id'");
                                    $statement8->execute();

                                    $statement9 = $conn->prepare("SELECT COUNT(*) AS ctn9 FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND centers_id = '10' AND user_id = '$user_id'");
                                    $statement9->execute();
                                    
                                    $statement10 = $conn->prepare("SELECT COUNT(*) AS ctn10 FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND centers_id = '11' AND user_id = '$user_id'");
                                    $statement10->execute();
                                    
                                    $statement11 = $conn->prepare("SELECT COUNT(*) AS ctn11 FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND centers_id = '12' AND user_id = '$user_id'");
                                    $statement11->execute();
                                    
                                    $statement12 = $conn->prepare("SELECT COUNT(*) AS ctn12 FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND centers_id = '13' AND user_id = '$user_id'");
                                    $statement12->execute();
                                    
                                    $statement13 = $conn->prepare("SELECT COUNT(*) AS ctn13 FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND centers_id = '14' AND user_id = '$user_id'");
                                    $statement13->execute();
                                    
                                    $statement14 = $conn->prepare("SELECT COUNT(*) AS ctn14 FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND centers_id = '15' AND user_id = '$user_id'");
                                    $statement14->execute();
                                ...
                                $centers_id = $_GET["branch"];
                                    ...
                                    $statement = $conn->prepare("SELECT COUNT(*) AS ss FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND package_id = '1' AND user_id = '$user_id'");
                                    $statement->execute();
                            
                                    $statement1 = $conn->prepare("SELECT COUNT(*) AS prs FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND package_id = '2' AND user_id = '$user_id'");
                                    $statement1->execute();
                            
                                    $statement2 = $conn->prepare("SELECT COUNT(*) AS psa FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND package_id = '3' AND user_id = '$user_id'");
                                    $statement2->execute();
                                    
                                    $statement3 = $conn->prepare("SELECT COUNT(*) AS psb FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND package_id = '4'AND user_id = '$user_id'");
                                    $statement3->execute();
                                    
                                    $statement4 = $conn->prepare("SELECT COUNT(*) AS psc FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND package_id = '5' AND user_id = '$user_id'");
                                    $statement4->execute();
                                    
                                    $statement5 = $conn->prepare("SELECT COUNT(*) AS psd FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND package_id = '6' AND user_id = '$user_id'");
                                    $statement5->execute();

                                    $statement6 = $conn->prepare("SELECT COUNT(*) AS pca FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND package_id = '7' AND user_id = '$user_id'");
                                    $statement6->execute();
                                    
                                    $statement7 = $conn->prepare("SELECT COUNT(*) AS pcb FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND package_id = '8' AND user_id = '$user_id'");
                                    $statement7->execute();
                                    
                                    $statement8 = $conn->prepare("SELECT COUNT(*) AS pcc FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND package_id = '9' AND user_id = '$user_id'");
                                    $statement8->execute();

                                    $statement9 = $conn->prepare("SELECT COUNT(*) AS pmcare FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND package_id = '10' AND user_id = '$user_id'");
                                    $statement9->execute();

                                    $statement10 = $conn->prepare("SELECT COUNT(*) AS ephysio FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND package_id = '11' AND user_id = '$user_id'");
                                    $statement10->execute();

                                    $statement11 = $conn->prepare("SELECT COUNT(*) AS other FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND package_id = '12' AND user_id = '$user_id'");
                                    $statement11->execute();
                                    
                                    $statement12 = $conn->prepare("SELECT COUNT(*) AS peadss FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND package_id = '13' AND user_id = '$user_id'");
                                    $statement12->execute();
                                    
                                    $statement13 = $conn->prepare("SELECT COUNT(*) AS peadpsa FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND package_id = '14' AND user_id = '$user_id'");
                                    $statement13->execute();
                                    
                                    $statement14 = $conn->prepare("SELECT COUNT(*) AS PEADSpsb FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND package_id = '15' AND user_id = '$user_id'");
                                    $statement14->execute();
                                    
                                    $statement15 = $conn->prepare("SELECT COUNT(*) AS peadpsc FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND package_id = '16' AND user_id = '$user_id'");
                                    $statement15->execute();
                                ...
                                $centers_id = $_GET["branch"];
                                    // SELECT (COUNT(status)*100 /(Select COUNT(*) From inquiry)) AS ctn1 From inquiry WHERE status = 'Pending'
                                    $statement = $conn->prepare("SELECT COUNT(*) AS ctn FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND engagement_id = '1' AND user_id = '$user_id'");
                                    $statement->execute();
                            
                                    $statement1 = $conn->prepare("SELECT COUNT(*) AS whatsapp FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND engagement_id = '2' AND user_id = '$user_id'");
                                    $statement1->execute();
                            
                                    $statement2 = $conn->prepare("SELECT COUNT(*) AS facebook FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND engagement_id = '3' AND user_id = '$user_id'");
                                    $statement2->execute();

                                    $statement3 = $conn->prepare("SELECT COUNT(*) AS website FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND engagement_id = '4' AND user_id = '$user_id'");
                                    $statement3->execute();

                                    $statement4 = $conn->prepare("SELECT COUNT(*) AS instagram FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND engagement_id = '5'AND user_id = '$user_id'");
                                    $statement4->execute();
                                    
                                    $statement5 = $conn->prepare("SELECT COUNT(*) AS twitter FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND engagement_id = '6' AND user_id = '$user_id'");
                                    $statement5->execute();
                                    
                                    $statement6 = $conn->prepare("SELECT COUNT(*) AS youtube FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND engagement_id = '7' AND user_id = '$user_id'");
                                    $statement6->execute();
                                    
                                    $statement7 = $conn->prepare("SELECT COUNT(*) AS email FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND engagement_id = '8' AND user_id = '$user_id'");
                                    $statement7->execute();
                                    
                                    $statement8 = $conn->prepare("SELECT COUNT(*) AS walkin FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND engagement_id = '9' AND user_id = '$user_id'");
                                    $statement8->execute();

                                    $statement9 = $conn->prepare("SELECT COUNT(*) AS referal FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND engagement_id = '10' AND user_id = '$user_id'");
                                    $statement9->execute();
                                ...
                                $centers_id = $_GET["branch"];
                                    ...
                                    $statement = $conn->prepare("SELECT COUNT(*) AS backpain FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND pain_id = '1' AND user_id = '$user_id'");
                                    $statement->execute();
                            
                                    $statement1 = $conn->prepare("SELECT COUNT(*) AS slipdics FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND pain_id = '2' AND user_id = '$user_id'");
                                    $statement1->execute();
                            
                                    $statement2 = $conn->prepare("SELECT COUNT(*) AS stroke FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND pain_id = '3' AND user_id = '$user_id'");
                                    $statement2->execute();

                                    $statement3 = $conn->prepare("SELECT COUNT(*) AS kneepain FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND pain_id = '4' AND user_id = '$user_id'");
                                    $statement3->execute();

                                    $statement4 = $conn->prepare("SELECT COUNT(*) AS neckpain FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND pain_id = '5'AND user_id = '$user_id'");
                                    $statement4->execute();
                                    
                                    $statement5 = $conn->prepare("SELECT COUNT(*) AS shoulderpain FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND pain_id = '6' AND user_id = '$user_id'");
                                    $statement5->execute();
                                    
                                    $statement6 = $conn->prepare("SELECT COUNT(*) AS elbowpain FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND pain_id = '7' AND user_id = '$user_id'");
                                    $statement6->execute();
                                    
                                    $statement7 = $conn->prepare("SELECT COUNT(*) AS sciantica FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND pain_id = '8' AND user_id = '$user_id'");
                                    $statement7->execute();
                                    
                                    $statement8 = $conn->prepare("SELECT COUNT(*) AS anklepain FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND pain_id = '9' AND user_id = '$user_id'");
                                    $statement8->execute();
                                    
                                    $statement9 = $conn->prepare("SELECT COUNT(*) AS scoliosis FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND pain_id = '11' AND user_id = '$user_id'");
                                    $statement9->execute();
                                    
                                    $statement10 = $conn->prepare("SELECT COUNT(*) AS others FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND pain_id = '12' AND user_id = '$user_id'");
                                    $statement10->execute();
                                    
                                    $statement11 = $conn->prepare("SELECT COUNT(*) AS nulls FROM tracker WHERE (created_date BETWEEN '2022-06-29' AND '2022-07-28') AND pain_id = '10' AND user_id = '$user_id'");
                                    $statement11->execute();
