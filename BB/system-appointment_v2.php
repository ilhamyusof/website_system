                                                        ...
                                                        <div class="row">
                                                        	<div class="table-responsive">
																<table id="example7" class="table table-striped table-bordered" style="width:100%">
																	...
																	<?php 
								                                        $statement = $conn->prepare("SELECT * FROM inquiry WHERE branch IN ('Kota Damansara', '4') AND status = 'New'");
								                                        $statement->execute();
													...
													<div class="row">
														<div class="table-responsive">
																<table id="example8" class="table table-striped table-bordered" style="width:100%">
																	...
																	<?php 
								                                        $statement = $conn->prepare("SELECT * FROM inquiry WHERE branch IN ('Kota Damansara', '4') AND status = 'Pending' ");
								                                        $statement->execute();
													...
													<div class="row">
														<div class="table-responsive">
																<table id="example9" class="table table-striped table-bordered" style="width:100%">
																	...
																	<?php 
								                                        $statement = $conn->prepare("SELECT * FROM inquiry WHERE branch IN ('Kota Damansara', '4') AND status = 'Close' ");
								                                        $statement->execute();
