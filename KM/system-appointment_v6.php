                                                        ...
                                                        <div class="row">
                                                        	<div class="table-responsive">
																<table id="example19" class="table table-striped table-bordered" style="width:100%">
																	...
																	<?php 
								                                        $statement = $conn->prepare("SELECT * FROM inquiry WHERE branch IN ('Bandar Baru Bangi','9') AND status = 'New'");
								                                        $statement->execute();
													...
													<div class="row">
														<div class="table-responsive">
																<table id="example20" class="table table-striped table-bordered" style="width:100%">
																	...
																	<?php 
								                                        $statement = $conn->prepare("SELECT * FROM inquiry WHERE branch IN ('Bandar Baru Bangi','9') AND status = 'Pending' ");
								                                        $statement->execute();
													...
													<div class="row">
														<div class="table-responsive">
																<table id="example21" class="table table-striped table-bordered" style="width:100%">
																	...
																	<?php 
								                                        $statement = $conn->prepare("SELECT * FROM inquiry WHERE branch IN ('Bandar Baru Bangi','9') AND status = 'Close' ");
								                                        $statement->execute();
