				...
				<div class="my-3 my-md-5 app-content">
					<div class="side-app">
                        ...
                        <?php
                            ...
                            {
                                $tracker_id = $_GET["id"];
                                $sql =  "SELECT tracker.tracker_id,tracker.lead, tracker.phone, tracker.inquiring, tracker.identification, tracker.gender, tracker.ic, tracker.pain_id, tracker.package_id, tracker.engagement_id, tracker.status, tracker.centers_id, tracker.therapist_id, tracker.payment, tracker.mri, tracker.created_date, tracker.user_id, tracker.created_by, user.user_id, user.name, pain.pain_id, pain.type_pain, package.package_id, package.package_name, package.package_display, package.price, therapist.therapist_id, therapist.name AS physio, engagement.engagement_id, engagement.engagement_name,centers.centers_id, centers.name AS branch
                                    FROM tracker
                                    JOIN user
                                           ...
                                           <div class="col-sm-6 col-md-6">
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2 custom-select" data-placeholder="Choose one" name="therapist_id" id="therapist_id">
                                                            <option label="Choose one"></option>
                                                            <?php
                                                                // $sql = $conn->prepare("SELECT tracker.tracker_id,tracker.lead, tracker.phone, tracker.inquiring, tracker.identification, tracker.gender, tracker.ic,
                                                                // tracker.pain_id, tracker.package_id, tracker.engagement_id, tracker.status, tracker.centers_id, tracker.therapist, tracker.payment, tracker.mri, tracker.created_date, tracker.user_id, tracker.created_by, user.user_id, user.name
                                                                //         FROM tracker
                                                                //         JOIN user
                                                                ...
                                                                {
                                                            ?>
                                                             <option value="<?php echo $read["therapist_id"]; ?>" <?php if($therapist == $read["therapist_id"]){ echo "selected"; } ?>>
                                                            <?php echo $read["name"]; ?>
                                                            </option>
                                                            <?php
                                                            }
