                    ...
                    <div class="container-fluid">
                        <div class="d-flex">
                            <a class="header-brand" href="index-2.html">
                                <img alt="ren logo" class="header-brand-img" src="assets-system/images/brand/logo.png">
                            </a>
                            ...
                            <div class="d-flex order-lg-2 ml-auto">
                                ...
                                <div class="dropdown d-none d-md-flex">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                        <a class="dropdown-item d-flex pb-3" href="#">
                                            <span class="avatar brround mr-3 align-self-center" style="background-image: url(assets-system/images/faces/male/4.jpg)"></span>
                                            <div>
                                        ...
                                        <a class="dropdown-item d-flex pb-3" href="#">
                                            <span class="avatar brround mr-3 align-self-center" style="background-image: url(assets-system/images/faces/female/14.jpg)"></span>
                                            <div>
                                        ...
                                        <a class="dropdown-item d-flex pb-3" href="#">
                                            <span class="avatar brround mr-3 align-self-center" style="background-image: url(assets-system/images/faces/male/1.jpg)"></span>
                                            <div>
                                ...
                                <div class="dropdown d-none d-md-flex">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                        ...
                                        <a class="dropdown-item d-flex pb-3" href="#"><span class="avatar brround mr-3 align-self-center" style="background-image: url(assets-system/images/faces/female/1.jpg)"></span>
                                            <div>
                                        ...
                                        <a class="dropdown-item d-flex pb-3" href="#"><span class="avatar brround mr-3 align-self-center" style="background-image: url(assets-system/images/faces/female/18.jpg)"></span>
                                            <div>
                                ...
                                <div class="dropdown">
                                    <a class="nav-link pr-0 leading-none d-flex" data-toggle="dropdown" href="#">
                                        <span class="avatar avatar-md brround" style="background-image: url(assets-system/images/faces/female/25.jpg)"></span>
                ...
                <aside class="app-sidebar">
                    ...
                    <ul class="side-menu">
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                <li><a class="slide-item" href="index-2.html">Career</a></li>
                                <li><a class="slide-item" href="index2.html">Appointment</a></li>
                                <li><a class="slide-item" href="index3.html">Contact Us</a></li>
                                <li><a class="slide-item" href="index4.html">Training Therapits</a></li>
                            </ul>
                        </li>
                         <li class="slide">
                            <a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fas fa-home"></i><span class="side-menu__label">Career Management</span><i class="angle fas fa-angle-right"></i></a>
                            <ul class="slide-menu">
                                <li><a class="slide-item" href="index-2.html">Record </a></li>
                        ...
                        <li class="slide">
                            <a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fas fa-home"></i><span class="side-menu__label">Appointment Management</span><i class="angle fas fa-angle-right"></i></a>
                            <ul class="slide-menu">
                        ...
                        <li class="slide">
                            <a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fas fa-table"></i><span class="side-menu__label">Tables</span><i class="angle fas fa-angle-right"></i></a>
                            <ul class="slide-menu">
                                <li>
